...
export const FIELD_SECTIONS: FieldSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "seller_lawyer_name", label: "Seller/Landlord Lawyer" },
      { key: "seller_lawyer_firm", label: "Seller/Landlord Lawyer Firm" },
      { key: "seller_lawyer_email", label: "Seller/Landlord Lawyer Email" },
      { key: "seller_lawyer_phone", label: "Seller/Landlord Lawyer Phone" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "buyer_lawyer_name", label: "Buyer/Tenant Lawyer" },
      { key: "buyer_lawyer_firm", label: "Buyer/Tenant Lawyer Firm" },
      { key: "buyer_lawyer_email", label: "Buyer/Tenant Lawyer Email" },
      { key: "buyer_lawyer_phone", label: "Buyer/Tenant Lawyer Phone" },
