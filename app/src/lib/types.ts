...
export const FIELD_SECTIONS: { title: string; fields: FieldDef[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "seller_phone", label: "Seller/Landlord Phone" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "listing_commission_pct", label: "Listing-Side Commission %" },
      { key: "cooperating_commission_pct", label: "Co-operating-Side Commission %" },
